...
function cap4() {
  return [
    ...
    xpBox([
      ...
      ["MS-1A: El Festival Roto", "Secundaria (Aftermath, ver sección 4.9)", "Diseños de cometas de la madre de Sella + 1-2 Cometas de Sella, calidad según éxitos en el mini-desafío del patrón (ver tabla en 4.9)"],
    ...
    infoTable([
      ...
      ["0","Sale frágil — Sella no se rinde y lo termina igual, pero apenas aguanta el viento","1 Cometa de Sella puramente decorativa: no vuela de verdad, sin efecto mecánico. El cierre emocional de Sella pasa igual, sin cambios"],
      ["1","Sale débil pero entera — vuela, aunque no aguanta un golpe fuerte","1 Cometa de Sella de un solo uso: la próxima vez que el portador caiga, reduce el daño en 1d6, y después se rompe para siempre"],
      ["2","Más tosca de lo que a Sella le hubiera gustado, pero funcional — agradece igual, sabiendo que no quedó perfecta","1 Cometa de Sella reutilizable: reduce el daño de una caída en 1d6, 1 vez por descanso largo"],
      ["3","Casi perfecta — Sella nota un detalle fuera de lugar y lo menciona sin remordimiento, satisfecha igual","1 Cometa de Sella con efecto completo: reduce el daño de una caída a la mitad, 1 vez por descanso largo"],
      ["4","Queda perfecto — Sella llora de alivio, no de tristeza, al verlo terminado","Par completo de Cometas de Sella: cada una reduce el daño de una caída a la mitad, 1 vez por descanso largo (una para repartir a cada uno de dos personajes)"],
    ], 2400, 5200, 5600),
    pEmpty(80),
